...
<table>
 <tr>
  ...
  <?php
        ...
        echo '</div>';
        echo '<font color="black"><h2 style="text-align:center">Confirm Orders</h2></font>';
...
<?php
 echo "<td class = 'noborders'><a href='http://localhost/buch/Admin/Orders/confirmordersdb.php?id=$id&bid=$bid&pid=$pid'><p><button class='button'><span>Confirm</span></button></p></a></td>";
   }
        mysqli_close($conn);
?>
</table>
