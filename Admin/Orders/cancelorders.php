...
<table>
  ...
  <?php
        ...
        echo '</div>';
        echo '<font color="black"><h2 style="text-align:center">Cancel Orders</h2></font>';
...
<?php 
 ...
 echo "<td class = 'noborders'><a href='http://localhost/buch/Admin/Orders/cancelordersdb.php?id=$id&bid=$bid'><p><button class='button'><span>Cancel</span></button></p></a></td>";
?>
  </tr>
<?php
   }
