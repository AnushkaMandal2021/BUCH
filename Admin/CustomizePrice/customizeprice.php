...
<a href="http://localhost/buch/Admin/customerreviews/customerreviews.php" class="w3-bar-item w3-button w3-xlarge">View Customer Reviews</a>
 ...
 <div class="card">
   ...
   <font color="black"><h2 style="text-align:center">Customize Prices By:</h2></font></a><br>
     <div class="row">
     <div class="column">
     <a href="http://localhost/buch/Admin/CustomizePrice/customizebyname.php"><button class="button"><span>Book Name</span></button></a><br>       
     <a href="http://localhost/buch/Admin/CustomizePrice/customizebygenre.php"><button class="button"><span>Book Genre</span></button></a><br>
     <a href="http://localhost/buch/Admin/CustomizePrice/customizebypublicationyear.php"><button class="button"><span>Publication Year</span></button></a><br>
     </div>
     <div class="column">
     <a href="http://localhost/buch/Admin/CustomizePrice/customizebyauthor.php"><button class="button"><span>Author</span></button></a><br>
     <a href="http://localhost/buch/Admin/CustomizePrice/customizebypublisher.php"><button class="button"><span>Publisher</span></button></a><br>
     </div>
     </div>
