...
<a href="http://localhost/buch/Admin/customerreviews/customerreviews.php" class="w3-bar-item w3-button w3-xlarge">View Customer Reviews</a>
 ...
 <div class="card">
   ...
   <font color="black"><h2 style="text-align:center">Change genre</h2></font><br>
   <form action = "dbconn2.php" method="POST">
    <div class="row">
      <div class="column">
      <font color="black"><h4><b>Enter the Bookname</b></h4></font><br><br>
      <font color="black"><h4><b>New genre</b></h4></font><br>
      </div>
      <div class="column">
      <input type="text" name="bookname" placeholder="Enter The Book Name">
      <input type="text" name="genre" placeholder="Enter the new genre"><br><br>
