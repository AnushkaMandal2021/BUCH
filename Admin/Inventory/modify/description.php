...
<body>
 <div class="w3-sidebar w3-teal w3-bar-block" style="width:25%">
  ...
  <div class="dropdown-content">
    ...
    <a href="http://localhost/buch/Admin/Inventory/modifybook.php">Modify Book</a>
  </div>
</div>
<div class="dropdown">
...
<a href="http://localhost/buch/Admin/customerreviews/customerreviews.php" class="w3-bar-item w3-button w3-xlarge">View Customer Reviews</a>
 ...
 <div class="card">
   ...
   <font color="black"><h2 style="text-align:center">Change Description</h2></font><br>
   <form action = "dbconn8.php" method="GET">
    <div class="row">
      <div class="column">
      <font color="black"><h4><b>Enter Book Name</b></h4></font><br>
      <font color="black"><h4><b>New Description</b></h4></font><br>
      </div>
      <div class="column">
