...
<a href="http://localhost/buch/Admin/customerreviews/customerreviews.php" class="w3-bar-item w3-button w3-xlarge">View Customer Reviews</a>
 ...
 <div class="card">
   ...
   <font color="black"><h2 style="text-align:center">Change Book name</h2></font><br>
    <form action = "dbconn1.php" method="GET">
    <div class="row">
      <div class="column" >
      <font color="black"><h4><b>Old book name</b></h4></font><br>
      <font color="black"><h4><b>New book name</b></h4></font><br>
      </div>
      <div class="column">
      <input type="text" name="name1" placeholder="Enter The Book Name">
      <input type="text" name="name2" placeholder="Enter the new book name"><br><br>
      <button class="button"><span>MODIFY</span></button><br>
      </div>
   </div>
   </form>
 </div>
