...
<a href="http://localhost/buch/Admin/customerreviews/customerreviews.php" class="w3-bar-item w3-button w3-xlarge">View Customer Reviews</a>
 ...
 <div class="card">
   <br>
   <font color="black"><h2 style="text-align:center">Modify Book</h2></font><br>
   
      <a href="bookname.php"><button class="button"><span>Book name</span></button></a>
   
      <a href="genre.php"><button class="button"><span>Genre</span></button></a><br>
    
      <a href="price.php"><button class="button"><span>Price</span></button></a>
    
      <a href="author.php"><button class="button"><span>Author</span></button></a><br>
    
      <a href="publisher.php"><button class="button"><span>Publisher</span></button></a>
    
      <a href="publication.php"><button class="button"><span>Publication Year</span></button></a><br>
    
      <a href="ratings.php"><button class="button"><span>Ratings</span></button></a>
    
      <a href="description.php"><button class="button"><span>Description</span></button></a><br>
