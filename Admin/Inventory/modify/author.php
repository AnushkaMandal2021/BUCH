...
<a href="http://localhost/buch/Admin/customerreviews/customerreviews.php" class="w3-bar-item w3-button w3-xlarge">View Customer Reviews</a>
 ...
 <div class="card">
   ...
   <font color="black"><h2 style="text-align:center">Change Author</h2></font><br>
   <form action = "dbconn4.php" method="GET">
    <div class="row">
      <div class="column">
      <font color="black"><h4><b>Enter Book Name</b></h4></font><br><br>
      <font color="black"><h4><b>New author name</b></h4></font><br>
      </div>
      <div class="column">
      <input type="text" name="bookname" placeholder="Enter The Book Name">
      <input type="text" name="author" placeholder="Enter the author name"><br><br>
