...
<a href="http://localhost/buch/Admin/customerreviews/customerreviews.php" class="w3-bar-item w3-button w3-xlarge">View Customer Reviews</a>
 ...
 <font color="black"><h2 style="text-align:center">Edit Inventory.</h2></font>

<div class="card">
   <br>
   <font color="black"><h2 style="text-align:center">Add Book</h2></font><br>
             <form action = "dbcon9.php" method="GET">
            <font color="black"><h4>Book Name</h4></font>
            <input type="text" name="bookname" placeholder="Enter Book Name">
            <font color="black"><h4>Price</h4></font>
            <input type="text" name="price" placeholder="Enter Book Price">
            <font color="black"><h4>Rating</h4></font>
            <input type="text" name="rating" placeholder="Enter Rating">
            <font color="black"><h4>Author</h4></font>
            <input type="text" name="author" placeholder="Enter Author">
            <font color="black"><h4>Genre</h4></font>
            <input type="text" name="genre" placeholder="Enter Genre">
            <font color="black"><h4>Publisher</h4></font>
            <input type="text" name="publisher" placeholder="Enter Publisher">
            <font color="black"><h4>Publication Year</h4></font>
            <input type="text" name="publicationyear" placeholder="Enter Publication Year">
            <font color="black"><h4>Book Description</h4></font>
            <textarea id="message" name="message" placeholder="Book Description.." style="height:1000px width:1000px"></textarea><br><br>
             
            <button class="button" type="submit" name="submit"><span>Add</span></button>
            </form>
 </div>
</body>
</html>
