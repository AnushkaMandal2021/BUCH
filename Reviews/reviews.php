...
<div class="card">
<form action="reviewsdb.php" method="GET">
...
<h3> <strong> Title  </h3> <span class= "w3-text-red" style="font-size: 20px">(Should be within 100 characters)</span></strong>
  <textarea id="message" name="head" rows="1" cols="87" maxlength="100" required></textarea><br>
<h3> <strong> Review  </h3><span class= "w3-text-red" style="font-size: 20px">(Should be within 500 characters)</span></strong>
  <textarea id="message" name="body" rows="10" cols="87" maxlength="500" required></textarea>
  <button class="button"><span>POST</span></button><br>
  <?php 
$_SESSION['pid'] = $_GET['id'];
$_SESSION['$bid1'] = $_GET['bid'];
  ?>
</form>
