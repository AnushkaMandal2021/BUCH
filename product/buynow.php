    ...
    <div class="column">
        <?php
             ...
             $sql1 = "SELECT * FROM address WHERE C_ID = '$a'";
              ...
              echo '<br>';
            echo '<strong><span style="font-size:20px">1</strong></span>';
                  echo '<strong><p style="font-size:20px">'.$_SESSION["i7"].'</p></strong>';
...
echo "<a href='http://localhost/buch/product/buynowdb.php?'><p><button class='button'><span style = 'font-size:20px'>BUY</span></button></p></a>";
